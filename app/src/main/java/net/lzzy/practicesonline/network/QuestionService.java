...
public class QuestionService {
    public  static String getQuestionsOfPracticeFromServer(int apId) throws IOException {
        String address = ApiConstants.URL_QUESTIONS + apId;
    ...
    public static List<Option> getOptionsFromJson(String jsonOptions,String jsonAnswers)throws IllegalAccessException,InstantiationException,JSONException{
